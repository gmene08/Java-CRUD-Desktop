...
public class EntregaController extends InterfaceController {
    ...
    public Boolean salvar() {
        try {
            ...
            System.getLogger(EntregaController.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
            return false;
        }
    }
